// ChambresTriples page - Dedicated page for Triple Rooms with photo gallery and lightbox
// Features all triple room photos with expandable lightbox viewing
  ...
  const chambreImages = [
    {
      id: 1,
      src: "/chambre3.jpg",
      alt: "Chambre Triple - Vue principale"
    },
    {
      id: 2,
      src: "/chambre3.jpg",
      alt: "Chambre Triple - Détails"
    },
    {
      id: 3,
      src: "/chambre3.jpg",
      alt: "Chambre Triple - Ambiance"
    }
  ];
        ...
        <section className="py-16 px-4 bg-gradient-to-br from-logo-gold/10 to-logo-dark/10">
          <div className="container mx-auto">
            ...
            >
              ...
              >
                <p>
                  Nos chambres triples offrent un espace généreux pour accueillir jusqu'à trois personnes,
                  parfaites pour les petites familles ou les groupes d'amis. Confortables et spacieuses,
                  elles allient élégance et authenticité tunisienne pour un séjour agréable.
                </p>
              </motion.div>
            </motion.div>
          </div>
            ...
            >
              ...
              >
                ...
                <p className="mb-4 text-lg text-foreground/90 leading-relaxed">
                  La Chambre Triple est conçue pour accueillir confortablement jusqu'à trois personnes 
                  dans un cadre à la fois spacieux et chaleureux. Idéale pour les petites familles, 
                  les groupes d'amis ou les voyageurs souhaitant partager un même espace, elle combine 
                  trois lits individuels ou un lit double et un simple, selon les besoins.
                </p>
                <p className="mb-4 text-lg text-foreground/90 leading-relaxed">
                  Les matériaux naturels, les voûtes élégantes et les touches artisanales locales 
                  créent une ambiance authentique et apaisante.
                </p>
                <p className="text-lg text-foreground/90 leading-relaxed">
                  Alliant esprit traditionnel et confort moderne, cette chambre offre une expérience 
                  conviviale, fidèle à l'atmosphère accueillante de Dar Dhiafa Paul Klee.
                </p>
              </motion.div>
            </motion.div>
          </div>
...
export default ChambresTriples;
