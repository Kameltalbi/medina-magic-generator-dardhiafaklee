// ChambresFamiliales page - Dedicated page for Family Rooms with photo gallery and lightbox
// Features all family room photos with expandable lightbox viewing
...
const ChambresFamiliales = () => {
  ...
  const chambreImages = [
    {
      id: 1,
      src: "/chambre-familial3.jpg",
      alt: "Chambre Familiale - Vue principale"
    },
    {
      id: 2,
      src: "/chambre-filial1.jpg",
      alt: "Chambre Familiale - Espace famille"
    },
    {
      id: 3,
      src: "/chambre-familil2.jpg",
      alt: "Chambre Familiale - Détails"
    }
  ];
        ...
        <section className="py-16 px-4 bg-gradient-to-br from-logo-gold/10 to-logo-dark/10">
          <div className="container mx-auto">
            ...
            >
              ...
              >
                <p>
                  Nos chambres familiales offrent un espace généreux avec 2 grands lits, 
                  parfaites pour les familles avec enfants. Spacieuses et confortables, 
                  elles allient confort moderne et charme authentique tunisien pour un 
            ...
            >
              ...
              >
                ...
                <p className="mb-4 text-lg text-foreground/90 leading-relaxed">
                  La Chambre Familiale offre un espace généreux, pensé pour accueillir confortablement 
                  parents et enfants dans une atmosphère conviviale et chaleureuse. Son agencement 
                  harmonieux marie les matériaux naturels, les voûtes traditionnelles et les teintes 
                  douces qui invitent au repos.
                </p>
                <p className="mb-4 text-lg text-foreground/90 leading-relaxed">
                  Composée de deux grands lits, d'une salle de bain privative et d'un coin détente, 
                  elle offre tout le confort nécessaire pour un séjour paisible.
                </p>
                <p className="text-lg text-foreground/90 leading-relaxed">
                  Idéale pour les familles souhaitant découvrir Kairouan dans le calme d'une demeure 
                  d'art et de caractère, elle allie authenticité, confort et sérénité.
                </p>
              </motion.div>
            </motion.div>
          </div>
...
export default ChambresFamiliales;
