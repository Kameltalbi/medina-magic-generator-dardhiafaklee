// ChambresTwin page - Dedicated page for Twin Rooms with photo gallery and lightbox
// Features all twin room photos with expandable lightbox viewing
...
const ChambresTwin = () => {
  ...
  const chambreImages = [
    {
      id: 1,
      src: "/chambretwin1.jpg",
      alt: "Chambre Twin - Vue principale"
    },
    {
      id: 2,
      src: "/chambretwin2.jpg",
      alt: "Chambre Twin - Détails"
    },
    {
      id: 3,
      src: "/chambretwin3.jpg",
      alt: "Chambre Twin - Ambiance"
    }
  ];
        ...
        <section className="py-16 px-4 bg-gradient-to-br from-logo-gold/10 to-logo-dark/10">
          <div className="container mx-auto">
            ...
            >
              ...
              >
                <p>
                  Nos chambres twin offrent deux lits single séparés, parfaites pour les amis 
                  ou collègues. Confortables et fonctionnelles, elles allient élégance et 
                  authenticité tunisienne pour un séjour agréable.
                </p>
              </motion.div>
            </motion.div>
          </div>
            ...
            >
              ...
              >
                ...
                <p className="mb-4 text-lg text-foreground/90 leading-relaxed">
                  La Chambre Twin a été pensée pour offrir un confort optimal à deux voyageurs 
                  souhaitant partager un même espace tout en conservant leur indépendance. Ses deux 
                  lits jumeaux, son éclairage naturel et son décor sobre et raffiné créent une 
                  atmosphère apaisante, idéale pour se détendre après une journée de découverte.
                </p>
                <p className="text-lg text-foreground/90 leading-relaxed">
                  Chaque détail, du mobilier artisanal aux nuances douces des murs, reflète 
                  l'authenticité de la maison d'hôtes. Parfaite pour les amis, collègues ou membres 
                  d'une même famille, cette chambre allie fonctionnalité, élégance et sérénité.
                </p>
              </motion.div>
            </motion.div>
          </div>
